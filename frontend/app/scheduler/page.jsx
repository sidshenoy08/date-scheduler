...
export default function Scheduler() {
  ...
  return (
    <div>
      <Center h="100vh" bgColor="pink.50">
        <VStack gap="4rem">
          <VStack>
            ...
            <Button style={{ marginTop: "1rem" }} colorPalette="pink" variant="solid" onClick={() => scrollToSection("dateActivities")}>
              Confirm
            </Button>
          </VStack>
          <div id='dateActivities'>
            <h1 className='!font-sans !text-2xl !font-bold'>Choose some fun activities for our date!</h1>
            <DateActivities />
          </div>
        </VStack>
      </Center>
